...
try {
    ...
    res.status(500).json({message: "An error occurred while fetching bus details.",error: error.message || "Internal Server Error",
    });
}
};
...
try {
    ...
    res.status(500).json({message: "An error occurred while adding the bus and bus route.",
...
try {
    ...
    res.status(500).json({message: "An error occurred while deleting the bus and bus route.",error: error.message || "Internal Server Error",
    });
}
};
